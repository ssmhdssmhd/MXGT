        ...
        case 'jx/list':
            ...
            sendJsonResponse([
                ...
                'usage' => [
                    ...
                    'v2 统一接口(type指定)'          => 'mx.php?action=api/v2&type=parse&url=视频链接',
                    '官替解析-精简'                  => 'mx.php?action=official_replace/info&url=视频链接',
                    '官替解析-完整'                  => 'mx.php?action=official_replace/resolve&url=视频链接',
                    '接口列表(本页)'                 => 'mx.php?action=parse/list',
                ],
                'supported_types' => [
                    'parse' => '智能解析（自动判断类型）',
                    'mxjx' => '去广告解析（M3U8 去广告）',
